...
SECRET_KEY = 'django-insecure-j_(1!ve$#kcpz8q8_v-dx9dk0i@&u5-77@daite_zs2f=4!*pz'
...
INSTALLED_APPS = [
    'corsheaders',  # Must be at the top for proper CORS handling
...
# DRF Configuration with JWT Authentication and global permission
...
# CORS Configuration - Allow your frontend dev URL to access backend API
